...
public class StringListView extends JDialog {
...
// call onCancel() on ESCAPE
    ...
    private void onOK() {
        ...
        for (int i = 0; i < model.getSize(); i++) {
            stringValues.add(model.getElementAt(i));
        }
        dispose();
    }
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!textField1.getText().isEmpty()) {
                    ((DefaultListModel) list1.getModel()).addElement(textField1.getText());
                }
            }
        });
    ...
    public static void main(String[] args) {
        StringListView dialog = new StringListView();
        dialog.pack();
        dialog.setVisible(true);
        System.exit(0);
    }

    public void setStringList(List<String> values) {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel5.add(addButton, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
